...
146 тестов, без сети и без поднятого PostgreSQL. Тестовая БД — SQLite во
...
**Шаг 0 не выполнен.** Разведка архива отчётов делается человеком и блокирует
завершение этапа. Пока она не сделана:
