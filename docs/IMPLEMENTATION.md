...
* **суммы**. Обезличенный архив обнуляет числа, поэтому по нему нельзя проверить,
  входит ли НКД в сумму сделки (A-07), брутто или нетто приходит купон (A-04) и
  где именно приходит вознаграждение за заём бумаг (A-21, A-24). Все три
  закрываются первым же прогоном по настоящему архиву: расхождение денег на
  сверке укажет ровно на них;
