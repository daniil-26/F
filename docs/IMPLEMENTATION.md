...
Допущения A-04 и A-07 подтверждены **косвенно**: неверное любое из них дало бы
расхождение денег ровно на сумму налога или НКД месяца, а архив сошёлся.
Проверка годна настолько, насколько такие операции в архиве встречались.
