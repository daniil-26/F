...
COLUMNS: dict[str, tuple[str, ...]] = {
    ...
    # Архив 2017–2020: «Дата оплаты» и «Дата поставки», каждая плановая и
    # фактическая. Для денег берётся фактическая дата оплаты (A-03).
    "settlement_date": (
...
# Точка-разделитель составного заголовка («Дата оплаты · Фактическая») — такая
# же пунктуация, как кавычки: без неё подпись «дата оплаты фактическая» не
# находится в имени колонки.
