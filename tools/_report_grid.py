...
HEADER_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "trade_kind": ("вид сделки", "тип сделки"),
...
# «5.1 Биржевые сделки…»: номер, затем текст, начинающийся с буквы. Требование
# буквы отсекает «1 234 567.89», которое иначе читается как секция «1».
_SECTION_RE = re.compile(r"^(\d{1,2}(?:\.\d{1,2})?)\.?\s+([^\W\d_].*)$")
